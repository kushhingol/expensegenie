...
function createBaseUser(): User {
  return { name: "", email: "", googleId: "", profilePic: "", createdAt: undefined };
}
...
export const User: MessageFns<User> = {
  encode(message: User, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.googleId !== "") {
      writer.uint32(26).string(message.googleId);
    }
  ...
  fromJSON(object: any): User {
    return {
      ...
      profilePic: isSet(object.profilePic) ? globalThis.String(object.profilePic) : "",
